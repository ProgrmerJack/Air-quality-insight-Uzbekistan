...
df = pd.read_csv(os.path.join(OUT, "us_embassy_2022_2023.csv"))
...
with open(os.path.join(OUT,"pm25_diurnal_profile.csv"),"w",newline="") as fh:
...
with open(os.path.join(OUT,"pm25_period_summary.csv"),"w",newline="") as fh:
...
with open(os.path.join(OUT,"seasonal_analysis.csv"),"w",newline="") as fh:
