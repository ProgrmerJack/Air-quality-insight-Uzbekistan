...
for iso in COUNTRIES:
    ...
    bycountry[iso] = pts
    with open(os.path.join(OUT, f"giga_schools_{iso}.csv"), "w", newline="", encoding="utf-8") as f:
...
for cap, (iso, s, w, n, e) in CAPITALS.items():
    ...
    with open(os.path.join(OUT, f"giga_schools_{cap.lower()}.csv"), "w", newline="", encoding="utf-8") as f:
...
with open(os.path.join(OUT, "giga_regional_summary.csv"), "w", newline="", encoding="utf-8") as f:
